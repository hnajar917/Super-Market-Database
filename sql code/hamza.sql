CREATE DATABASE supermarket_sql;
use supermarket_sql;
...
insert into employee(username, name, password, email, age, phone, title, hourly_pay, start_date) values ('hamza1', 'hamza najjar', 'hamza1','hamza@gmail.com' , 21,'97058972394' , 'manager' , 15, '2020-09-12');